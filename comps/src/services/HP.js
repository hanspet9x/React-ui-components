export const HP = {
  ...
  getRandomWords : (size)=>{
    ...
    const alps = ["A", "S", "D", "F", "G", "H", "J", "K", "L", "Z", "X", "C", "V", "B", "N", "M", "Q", "W", 
        "E", "R", "T", "Y", "U", "I", "O", "P", "a", "s", "d", "f", "g", "h", "j", "k", "l", "z", "x", "c", "v",
        "b", "n", "m", "q", "w", "e", "r", "t", "y", "u", "i", "o", "p", 1, 2, 3, 4, 5, 6, 7, 8, 9, 0];
    
    if(size > alps.length) throw new Error(size+" shouldn't be greater than "+alps.length);
...
export class Listener{
  ...
  on(name, evt){
    if(evt.constructor !== Function) throw new Error("Event must be a function.");
