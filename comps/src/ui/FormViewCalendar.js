...
import { MdKeyboardArrowUp, MdKeyboardArrowDown, MdEvent, MdTimer, MdAccessTime, MdDescription } from "react-icons/md";
        ...
        <div className={`form-view-calendar-form ${cName}`}>
            ...
            <form className="form-block" onSubmit={handleSubmit}>
                ...
                <div className="form-inline">
                    <label>Start</label>
                    <ImageField required={true}  onChange={inputChange} type="date" src={<MdAccessTime />} placeholder={date} name="start" value={state.start} />
                </div>
                <div className="form-inline">
                    <label>End</label>
                    <ImageField required={true}  onChange={inputChange} type="date" src={<MdTimer />} name="end" value={state.end}/>
                </div>
                <label>Description</label>
                <ImageField required={true}  onChange={inputChange} type="date" src={<MdDescription />} tag="t" name="description" value={state.description}/>
